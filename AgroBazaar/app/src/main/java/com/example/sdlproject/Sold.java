...
public class Sold {
    ...
    String productRandomKey, saveCurrentDate, saveCurrentTime, approval, id, item_name, qty, price;

    public Sold(String approval, String id, String item_name, String qty, String price) {
