...
public class RecyclerViewAdapterBuyer extends RecyclerView.Adapter<RecyclerViewAdapterBuyer.MyViewHolder> implements Filterable {
    ...
    public RecyclerViewAdapterBuyer(FragmentActivity mContext, List<Upload> mData) {
        this.mContext = mContext;
        this.mData = mData;
        mDataFull = new ArrayList<>(mData);
    }

//    public RecyclerViewAdapterBuyer(MainActivity mainActivity, List<Upload> lstBook) {
//
//    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        Intent intent = new Intent(mContext, FarmersListActivity.class);
                        intent.putExtra("Crop_name", mData.get(position).getName());
